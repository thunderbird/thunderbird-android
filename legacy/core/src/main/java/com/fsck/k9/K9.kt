...
object K9 : KoinComponent {
    ...
    @set:Synchronized
    @JvmStatic
    var sortType: SortType = LegacyAccount.DEFAULT_SORT_TYPE
    ...
    fun loadPrefs(storage: Storage) {
        ...
        sortType = storage.getEnum("sortTypeEnum", LegacyAccount.DEFAULT_SORT_TYPE)

        val sortAscendingSetting = storage.getBoolean("sortAscending", LegacyAccount.DEFAULT_SORT_ASCENDING)
