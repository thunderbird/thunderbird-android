...
public class LockableDatabase {
    ...
    public LockableDatabase(Context context, DatabaseFilesProvider databaseFilesProvider,
    ...
    protected File prepareStorage() {
        final File databaseFile = databaseFilesProvider.getDatabaseFile();
        ...
        final File attachmentDir = databaseFilesProvider.getAttachmentDirectory();
    ...
    private void delete(final boolean recreate) {
        ...
        try {
            ...
            try {
                final File attachmentDirectory = databaseFilesProvider.getAttachmentDirectory();
            ...
            try {
                deleteDatabase(databaseFilesProvider.getDatabaseFile());
            } catch (Exception e) {
