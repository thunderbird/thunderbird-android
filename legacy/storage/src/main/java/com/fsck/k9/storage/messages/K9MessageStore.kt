...
class K9MessageStore(
    ...
    private val attachmentFileManager = AttachmentFileManager(databaseFilesProvider)
    ...
    private val databaseOperations = DatabaseOperations(database, databaseFilesProvider)
