...
import net.thunderbird.feature.messages.fakes.FakeAccount
import net.thunderbird.feature.messages.fakes.FakeAccountManager
import net.thunderbird.feature.messages.fakes.FakeBackendFolderUpdater
import net.thunderbird.feature.messages.fakes.FakeBackendStorageFactory
import net.thunderbird.feature.messages.fakes.FakeSpecialFolderUpdaterFactory
...
class CreateArchiveFolderTest {
    ...
    fun `invoke should emit InvalidFolderName and complete flow when folderName is invalid`() = runTest {
        ...
        val accountManager = spyk(FakeAccountManager(accounts))
    ...
    fun `invoke should emit UnhandledError and complete flow when BackendStorage createFolder throws MessagingException`() =
        runTest {
            ...
            val remoteFolderCreatorFactory = spyk(FakeRemoteFolderCreatorFactory(outcome = null))
    ...
    fun `invoke should emit LocalFolderCreationError and complete flow when BackendStorage createFolder returns null`() =
        runTest {
            ...
            testSubject(accountUuid, folderName).test {
                ...
                verify(exactly = 1) {
                    // verify isn't correct verifying the extension function `createFolder`,
...
private class FakeRemoteFolderCreatorFactory(
    ...
    val instance: RemoteFolderCreator = spyk(
        object : RemoteFolderCreator {
