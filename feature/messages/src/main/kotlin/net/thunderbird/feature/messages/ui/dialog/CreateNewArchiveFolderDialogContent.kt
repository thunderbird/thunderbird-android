...
internal fun RowScope.CreateNewArchiveFolderDialogButtons(
    ...
    TextButton(
        ...
        Text(text = stringResource(R.string.setup_archive_folder_dialog_cancel))
    }
    TextButton(
        onClick = onCreateAndSetClick,
        enabled = isSynchronizing.not(),
    ) {
        Text(text = stringResource(R.string.setup_archive_folder_dialog_create_and_set_new_folder))
    }
}
