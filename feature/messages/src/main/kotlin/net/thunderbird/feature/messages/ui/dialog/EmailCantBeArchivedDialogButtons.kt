        ...
        Box(
            ...
            Row {
                TextButton(onSkipClick) {
                    Text(text = stringResource(R.string.setup_archive_folder_dialog_skip_for_now))
                }
                TextButton(onSetArchiveFolderClick) {
                    Text(text = stringResource(R.string.setup_archive_folder_dialog_set_archive_folder))
                }
            }
        }
        Row(
            ...
            TextLabelSmall(text = "Do not show this message again")
        }
    }
}
...
private fun Preview() {
    PreviewWithThemeLightDark(
        ...
        Surface(
            ...
            val state by remember { mutableStateOf(State.EmailCantBeArchived(isDoNotShowDialogAgainChecked = false)) }
            Column(
