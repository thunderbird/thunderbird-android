...
internal class UpdateFetchingMailSettingsTest {
    ...
    fun `should update delete policy ON_DELETE`() = runTest {
        ...
        useCase(
            account.id,
            AccountSettingsDomainContract.UpdateFetchingMailSettingsCommand.UpdateWhenIDeleteAMessage("ON_DELETE"),
        )
    ...
    fun `should update expunge policy MANUAL`() = runTest {
        ...
        useCase(
            ...
            AccountSettingsDomainContract
                .UpdateFetchingMailSettingsCommand.UpdateEraseDeletedMessageOnServer("EXPUNGE_MANUALLY"),
        )
    ...
    fun `should update push folder limit`() = runTest {
        ...
        useCase(
            account.id,
            AccountSettingsDomainContract.UpdateFetchingMailSettingsCommand.UpdateOnMaxFolderToCheckWithPushChange(250),
        )
