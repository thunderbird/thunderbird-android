...
fun SearchSettingContent(
    ...
    builder: SearchSettingsContract.SettingsBuilder,
    ...
    provider.SettingView(
        title = stringResource(R.string.account_settings_search_action),
        subtitle = state.subtitle,
        settings = settings,
        onSettingValueChange = { setting -> handleSettingChange(setting, onEvent) },
        onBack = { onEvent(SearchSettingsContract.Event.OnBackPressed) },
        modifier = modifier,
        actions = {
