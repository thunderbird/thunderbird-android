...
import net.thunderbird.core.ui.compose.designsystem.template.pager.HorizontalTabPager
import net.thunderbird.core.ui.compose.designsystem.template.pager.TabConfig
    ...
    InAppNotificationScaffold(
        ...
        HorizontalTabPager(
            ...
            pages(
                ...
                tabConfigBuilder = {
                    TabConfig(title = resources.getString(it.titleRes))
                },
            ) { route ->
                when (route) {
