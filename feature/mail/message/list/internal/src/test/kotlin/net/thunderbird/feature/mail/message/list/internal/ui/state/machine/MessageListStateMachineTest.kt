        ...
        stateMachine.currentState.test {
            ...
            assertThat(awaitItem())
                ...
                .all {
                    ...
                    prop(MessageListState.LoadingMessages::swipeActions).isEqualTo(swipeActions)
                    prop(MessageListState.LoadingMessages::selectedSortTypes).isEqualTo(sortTypes)
                    prop(MessageListState.LoadingMessages::progress).isEqualTo(0f)
                    prop(MessageListState.LoadingMessages::folder).isNull()
                }
        ...
        runTest {
            ...
            stateMachine.currentState.test {
                ...
                assertThat(awaitItem())
                    ...
                    .all {
                        prop(MessageListState.LoadedMessages::folder).isNull()
                        prop(MessageListState.LoadedMessages::messages).isEqualTo(messages)
                        prop(MessageListState.LoadedMessages::activeMessage).isNull()
                        prop(MessageListState.LoadedMessages::preferences).isEqualTo(preferences)
                        prop(MessageListState.LoadedMessages::swipeActions).isEqualTo(swipeActions)
                        prop(MessageListState.LoadedMessages::selectedSortTypes).isEqualTo(sortTypes)
                        prop(MessageListState.LoadedMessages::isActive).isTrue()
                    }
            }
        }
