        ...
        Box(
            ...
            Row {
                TextButton(onSkipClick) {
                    TextLabelLarge(text = stringResource(R.string.setup_archive_folder_dialog_skip_for_now))
                }
                TextButton(onSetArchiveFolderClick) {
                    TextLabelLarge(text = stringResource(R.string.setup_archive_folder_dialog_set_archive_folder))
                }
            }
        }
        Row(
