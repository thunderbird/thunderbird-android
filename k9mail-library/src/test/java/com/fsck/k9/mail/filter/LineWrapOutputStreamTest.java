...
public class LineWrapOutputStreamTest {
    ...
    @Test
    public void testTrailingSpacePreservationLW20() throws IOException {
        Buffer baos = new Buffer();
        writeToLineWrapStream(20, baos);
        assertEquals(EXPECTED_WRAPPED_AT20, baos.readUtf8());
    }

    @Test
    public void testTrailingSpacePreservationLW40() throws IOException {
        Buffer baos = new Buffer();
        writeToLineWrapStream(40, baos);
        assertEquals(EXPECTED_WRAPPED_AT40, baos.readUtf8());
    }

    @Test
    public void testTrailingSpacePreservationLW60() throws IOException {
        Buffer baos = new Buffer();
        writeToLineWrapStream(60, baos);
        assertEquals(EXPECTED_WRAPPED_AT60, baos.readUtf8());
    }

    @Test
    public void testTrailingSpacePreservationLW80() throws IOException {
        Buffer baos = new Buffer();
        writeToLineWrapStream(80, baos);
        assertEquals(EXPECTED_WRAPPED_AT80, baos.readUtf8());
    }
