...
public class Tags {
    ...
    public static final int SYNC_PAGE = 0 << WbXml.PAGE_SHIFT;
    ...
    public static final int GIE_PAGE = GIE << WbXml.PAGE_SHIFT;
    ...
    public static final int CONTACTS_PAGE = CONTACTS << WbXml.PAGE_SHIFT;
    ...
    public static final int CALENDAR_PAGE = CALENDAR << WbXml.PAGE_SHIFT;
    ...
    public static final int FOLDER_PAGE = FOLDER << WbXml.PAGE_SHIFT;
    ...
    public static final int MREQ_PAGE = MREQ << WbXml.PAGE_SHIFT;
    ...
    public static final int EMAIL_PAGE = EMAIL << WbXml.PAGE_SHIFT;
    ...
    public static final int TASK_PAGE = TASK << WbXml.PAGE_SHIFT;
    ...
    public static final int MOVE_PAGE = MOVE << WbXml.PAGE_SHIFT;
    ...
    public static final int CONTACTS2_PAGE = CONTACTS2 << WbXml.PAGE_SHIFT;
    ...
    public static final int PING_PAGE = PING << WbXml.PAGE_SHIFT;
    ...
    public static final int SEARCH_PAGE = SEARCH << WbXml.PAGE_SHIFT;
    ...
    public static final int GAL_PAGE = GAL << WbXml.PAGE_SHIFT;
    ...
    public static final int PROVISION_PAGE = PROVISION << WbXml.PAGE_SHIFT;
    // EAS 2.5
    ...
    public static final int BASE_PAGE = BASE << WbXml.PAGE_SHIFT;
