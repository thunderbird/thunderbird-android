...
public class Prefs extends K9PreferenceActivity {
    ...
    private static final String PREFERENCE_NOTIFICATION_PRIVACY_MODE = "notification_privacy_mode";
    ...
    private ListPreference mNotificationPrivacyMode;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNotificationPrivacyMode = (ListPreference) findPreference(PREFERENCE_NOTIFICATION_PRIVACY_MODE);
        mNotificationPrivacyMode.setValue(K9.getNotificationPrivacyMode().toString());
    ...
    private void saveSettings() {
        ...
        K9.setNotificationPrivacyMode(NotificationPrivacyMode.valueOf(mNotificationPrivacyMode.getValue()));
