...
5. Test the build in the internal testing track
   - Release versions should be throuroughly tested with the test plan in Testrail
...
9. Send community updates to Matrix channels, and beta or planning mailing lists.
