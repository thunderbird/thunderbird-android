...
The [Architecture Decision Records](adr/README.md) document the architectural decisions made during the development of the project, providing context and rationale for key technical choices.
...
[Koin](https://insert-koin.io/) is used for dependency injection, with modules organized by feature:
...
For more details on the legacy integration, see the [Legacy Integration](legacy-integration.md) document.
