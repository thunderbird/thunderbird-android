...
- Located in the `:components:ui:bolt:designsystem` module for reuse across features
...
- Located in the `:components:ui:bolt:theme` module for reuse across features
