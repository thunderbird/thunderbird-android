...
internal object TonalColorPalette {
    ...
    val primary010 = Color(color = 0xFF001C39)
    val primary020 = Color(color = 0xFF01325B)
    val primary030 = Color(color = 0xFF014881)
    val primary040 = Color(color = 0xFF0160A8)
    val primary050 = Color(color = 0xFF0279D2)
    val primary060 = Color(color = 0xFF3494F1)
    val primary070 = Color(color = 0xFF6AAEFF)
    val primary080 = Color(color = 0xFFA2C9FF)
    val primary090 = Color(color = 0xFFD3E4FF)
    val primary095 = Color(color = 0xFFEAF1FF)
    val primary099 = Color(color = 0xFFFDFCFF)
