 ...
 * @param scrimPadding The padding for the scrim. Defaults to `24.dp`.
 * @param arrangement The arrangement for the previews. Defaults to `Arrangement.spacedBy(24.dp)`.
