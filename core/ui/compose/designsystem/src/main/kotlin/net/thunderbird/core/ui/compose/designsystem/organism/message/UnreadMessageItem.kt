...
import net.thunderbird.core.ui.compose.designsystem.atom.icon.filled.UnreadMailBadge
 ...
 * @param onFavouriteClick A lambda function to be invoked when the favourite button is clicked.
    ...
    MessageItem(
        trailing = {
            Box {
                avatar()
                Image(
                    imageVector = Icons.Filled.UnreadMailBadge,
        ...
        action = {
            IconButton(
                ...
                Icon(
                    ...
                    tint = if (favourite) MainTheme.colors.onSurfaceVariant else MainTheme.colors.onSurface,
                )
            }
        },
