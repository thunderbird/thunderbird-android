...
internal val OutlinedDownloadIcon: ImageVector by lazy {
    icon(
        name = "OutlinedDownloadIcon",
        viewportWidth = 960.0f,
        viewportHeight = 960.0f,
    ) {
        iconPath {
            moveTo(x = 480.0f, y = 640.0f)
            lineTo(x = 280.0f, y = 440.0f)
...
@Composable
private fun Preview() {
    Icon(imageVector = OutlinedDownloadIcon, contentDescription = null)
}
