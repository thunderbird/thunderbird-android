...
const val DISPLAY_SETTINGS_DEFAULT_MESSAGE_VIEW_BOTTOM_ACTION_BAR = false
...
data class DisplayVisualSettings(
    ...
    val isMessageViewBottomActionBar: Boolean = DISPLAY_SETTINGS_DEFAULT_MESSAGE_VIEW_BOTTOM_ACTION_BAR,
)
