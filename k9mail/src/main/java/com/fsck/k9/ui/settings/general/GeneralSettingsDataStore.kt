...
class GeneralSettingsDataStore(
    ...
    override fun getBoolean(key: String, defValue: Boolean): Boolean {
        return when (key) {
            ...
            "disable_notifications_during_quiet_time" -> K9.isNotificationDuringQuietTimeDisabled()
    ...
    override fun putBoolean(key: String, value: Boolean) {
        when (key) {
            ...
            "disable_notifications_during_quiet_time" -> K9.setNotificationDuringQuietTimeDisabled(value)
