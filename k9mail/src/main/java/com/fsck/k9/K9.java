...
public class K9 extends Application {
    ...
    public static boolean isQuietTime() {
        ...
        Integer startHour = Integer.parseInt(quietTimeStarts.split(":")[0]);
        Integer startMinute = Integer.parseInt(quietTimeStarts.split(":")[1]);
        Integer endHour = Integer.parseInt(quietTimeEnds.split(":")[0]);
        Integer endMinute = Integer.parseInt(quietTimeEnds.split(":")[1]);
