...
public class CryptoModeSelector extends FrameLayout implements OnSeekBarChangeListener {
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        int grey = getResources().getColor(R.color.crypto_grey);
        ...
        crossfadedColor = crossfadeColor(grey, getResources().getColor(R.color.crypto_blue), crossfadeValue2);
        modeIcon2.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey, getResources().getColor(R.color.crypto_orange), crossfadeValue3);
        modeIcon3.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey, getResources().getColor(R.color.crypto_green), crossfadeValue4);
