...
public class MessagingControllerTest {
    ...
    private CountDownLatch setupLatchOnSyncMailboxStarted() {
        ...
        }).when(listener).synchronizeMailboxStarted(account, FOLDER_NAME);
        return latch;
    }
    ...
    private CountDownLatch setupLatchOnSyncMailboxFinished(int totalMsgs, int newMsgs) {
        ...
        }).when(listener).synchronizeMailboxFinished(account, FOLDER_NAME, totalMsgs, newMsgs);
    ...
    private CountDownLatch setupLatchOnSyncMailboxFailed(String message) {
        ...
        }).when(listener).synchronizeMailboxFailed(account, FOLDER_NAME, message);
        return latch;
    }
    ...
    public void can_synchronize_folder_with_message() throws InterruptedException, MessagingException {
        ...
        thread.start();
        controller.synchronizeMailbox(account, FOLDER_NAME, listener, remoteFolder);
