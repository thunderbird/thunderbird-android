package net.thunderbird.components.ui.bolt.atom.icon.dualtone
...
internal val DualToneWarningIcon: ImageVector by lazy {
    icon(name = "DualToneWarningIcon") {
        iconPath(
            fillAlpha = 0.2f,
            strokeAlpha = 0.2f,
        ) {
...
@Composable
private fun Preview() {
    Icon(imageVector = DualToneWarningIcon, contentDescription = null)
}
