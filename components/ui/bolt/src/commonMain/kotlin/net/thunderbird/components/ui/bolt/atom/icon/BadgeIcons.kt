...
import net.thunderbird.components.ui.bolt.atom.icon.filled.FilledNewMailBadge
import net.thunderbird.components.ui.bolt.atom.icon.filled.FilledUnreadMailBadge
