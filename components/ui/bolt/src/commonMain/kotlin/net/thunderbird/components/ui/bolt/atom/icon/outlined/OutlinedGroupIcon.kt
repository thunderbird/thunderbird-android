...
internal val OutlinedGroupIcon: ImageVector by lazy {
    icon(
        name = "OutlinedGroupIcon",
...
@Composable
private fun Preview() {
    Icon(imageVector = OutlinedGroupIcon, contentDescription = null)
}
