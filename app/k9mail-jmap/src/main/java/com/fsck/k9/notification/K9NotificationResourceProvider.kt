...
class K9NotificationResourceProvider(private val context: Context) : NotificationResourceProvider {
    ...
    override fun checkingMailContent(accountName: String, folderName: String): String =
        context.getString(R.string.notification_bg_sync_content, accountName, folderName)
