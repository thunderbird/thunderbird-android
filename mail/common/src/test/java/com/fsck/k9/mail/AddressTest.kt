...
class AddressTest {
    ...
    fun `parse with Missing Email should not set personal`() {
        // Arrange
    ...
    @Test
    @Throws(Exception::class)
    fun `hostname is empty string without Address`() {
        // Arrange
        val nameOnly = "Max"
        ...
        val hostname = withAddress.hostname

        // Assert
        assertThat(withoutAddress.hostname).isEqualTo("")
